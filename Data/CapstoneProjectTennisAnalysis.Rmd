...
```{r warning=FALSE}
tennisdataM = read.csv("C:/Users/Sandra/Documents/DataScienceCert/Data/tennislist/tennismenslist.csv") 
tennisdataW = read.csv("C:/Users/Sandra/Documents/DataScienceCert/Data/tennislist/tenniswomenslist.csv") 
tennismerged <- left_join(tennisdata, tennisdataM, by=c("Player1"="PLAYER"))
merged <- left_join(tennisdata, tennisdataM, by=c("Player1"="PLAYER"))
merged2 <- left_join(merged, tennisdataW, by=c("Player1"="PLAYER"))

#substring
tournamentnamestr <- strsplit(tennisdata$tournamentname, split = "-")
names(tournamentnamestr) <- c("Tournament", "Gender", "Year")
names(tournamentnamestr)
